...
const InputFormat = ({
  ...
  const [internalValue, setInternalValue] = useState(formatText(defaultValue) || '');
  const [initialValue, setInitialValue] = useState(formatText(defaultValue) || '');
  ...
  const handleInputChange = (e) => {
    ...
    // Filtra el valor para permitir solo números y letras
    if(regex){
  ...
  useEffect(() => {
    setInternalValue(formatText(defaultValue));
  }, [defaultValue])
