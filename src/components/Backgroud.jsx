        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
          ...
          <defs>
            <radialGradient id="a" gradientUnits="objectBoundingBox">
              <stop offset="0" stopColor="currentColor" className={classA0} />
              <stop offset="1" stopColor="currentColor" className={classA1} />
            </radialGradient>
            <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="0" y1="750" x2="1550" y2="750">
              <stop offset="0" stopColor="currentColor" className={classB0} />
              <stop offset="1" stopColor="currentColor" className={classB1} />
            </linearGradient>
