...
const AutoForm = ({ name = 'form', data, primaryKey = {}, struc, onSubmit, onDelete, onCancel, focusIn = '', names = {}, types = {}, readOnly = {}, widthColumns = {}, onUpdateInput = {}, id, table }) => {
    ...
    const classNames = {
        divPadre: `relative container mx-auto max-w-screen-lg bg-zinc-100/70 text-zinc-700 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700 px-4 py-6 rounded-lg shadow-none tmn-fadeIn`,
        modalContainer: `relative w-full max-w-3xl bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg max-h-screen overflow-y-auto tmn-fadeIn transition-all duration-700 ease-in-out`,
        modalContainerFull: `relative w-full h-full max-h-screen overflow-y-auto bg-zinc-100 dark:bg-zinc-800 p-6 tmn-fadeIn transition-all duration-700 ease-in-out`,
        modalContainer2xl: `relative w-full max-w-2xl max-h-full bg-zinc-100 dark:bg-zinc-800 p-6 rounded-lg tmn-fadeIn transition-all duration-700 ease-in-out`,
        encabezado: `flex flex-col border-b rounded-t border-zinc-300 dark:border-zinc-700`,
        ...
        navInHeader: `flex w-full text-sm text-zinc-500 dark:text-zinc-500 border-b rounded-t border-zinc-200 dark:border-zinc-700`,
        buttonNavInHeader: `inline-block px-4 py-2 rounded-t-lg hover:bg-zinc-200 hover:text-zinc-700 dark:hover:bg-zinc-700 dark:hover:text-zinc-300`,
        footer: `flex items-center justify-between pt-4 gap-2 border-t border-zinc-300 dark:border-zinc-600`,
        ...
        title: `text-lg font-medium text-left text-zinc-600 dark:text-white leading-none`,
        subtitle: `mt-1 text-sm font-normal text-zinc-500 dark:text-zinc-400 leading-tight`,
        observ: `mt-1 ml-1 text-sm font-normal italic text-zinc-500 dark:text-zinc-500 leading-tight`,
        label: `flex items-center gap-1 pl-1 text-xs font-semibold text-zinc-500 dark:text-zinc-500`,
        input: `bg-white border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:outline-none focus:ring-sky-500 focus:border-sky-500  block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-700 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-sky-700 dark:focus:border-sky-700`,
        isCurrency: `flex bg-white border border-zinc-300 text-zinc-900 text-sm rounded-lg focus-within:outline-none focus-within:ring-sky-500 focus-within:border-sky-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-700 dark:placeholder-zinc-400 dark:text-white dark:focus-within:ring-sky-700 dark:focus-within:border-sky-700`,
        isCurrencyDisable: `flex bg-zinc-100 border border-zinc-300 text-zinc-900 text-sm rounded-lg focus-within:outline-none focus-within:ring-yellow-500 focus-within:border-yellow-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-700 dark:placeholder-zinc-400 dark:text-white dark:focus-within:ring-yellow-700 dark:focus-within:border-yellow-700`,
        labelCurrency: `inline-flex items-center pr-1 text-sm text-zinc-600 bg-transparent  dark:text-zinc-200 `,
        labelCurrencyDisable: `inline-flex items-center child pl-1 text-sm text-zinc-300 bg-transparent  dark:text-zinc-500 focus:outline-none focus:ring-sky-500`,
        inputCurrency: `inline-flex items-center pr-1 text-sm text-zinc-600 bg-transparent  dark:text-zinc-200 focus:outline-none focus:ring-sky-500`,
        inputCurrencyDisable: `inline-flex items-center child pl-1 text-sm text-zinc-300 bg-transparent  dark:text-zinc-500 focus:outline-none focus:ring-none`,
        textarea: `bg-white border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:outline-none focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-700 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-sky-700 dark:focus:border-sky-700 whitespace-pre-line`,
        labelCheckbox: `flex items-center gap-1 pl-1 text-xs font-semibold text-zinc-500 dark:text-zinc-500`,
        checkbox: `w-4 h-4 text-blue-600 bg-white border-zinc-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-zinc-800 focus:ring-2 dark:bg-zinc-700 dark:border-zinc-600`,
        inputDisable: `bg-zinc-100 border border-zinc-300 text-zinc-400 text-sm rounded-lg focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-zinc-800 dark:border-zinc-700 dark:placeholder-zinc-400 dark:text-zinc-500 dark:focus:ring-yellow-700 dark:focus:border-yellow-700`,
        select: `bg-white border border-zinc-300 text-zinc-900 text-sm rounded-lg focus:outline-none focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-700 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-sky-700 dark:focus:border-sky-700`,
        containerButtons: `flex items-center justify-start gap-4`,
        submit: '!m-0 flex capitalize items-center rounded-lg px-4 py-2 text-sm font-medium focus:outline-none focus:border border-sky-600 text-white bg-sky-600 shadow-lg shadow-sky-600/30 hover:shadow-sky-600/50 focus:bg-sky-800 hover:bg-sky-700 active:translate-y-0.5 transition-all duration-100 active:bg-sky-700 scale-100 hover:scale-105 hover:scale-100 dark:shadow-lg dark:shadow-sky-800/80 text-center',
        delete: '!m-0 flex capitalize items-center rounded-lg px-4 py-2 text-sm font-medium focus:outline-none focus:border border-red-600 text-white bg-red-600 shadow-lg shadow-red-600/30 hover:shadow-red-600/50 focus:bg-red-800 hover:bg-red-700 active:translate-y-0.5 transition-all duration-100 active:bg-red-700 scale-100 hover:scale-105 dark:shadow-lg dark:shadow-red-800/80 text-center',
        cancel: '!m-0 flex capitalize items-center rounded-lg px-4 py-2 text-sm font-medium focus:outline-none focus:border border-zinc-600 text-white bg-zinc-600 shadow-lg shadow-zinc-600/30 hover:shadow-zinc-600/50 focus:bg-zinc-800 hover:bg-zinc-700 active:translate-y-0.5 transition-all duration-100 active:bg-zinc-700 scale-100 hover:scale-105 dark:shadow-lg dark:shadow-zinc-800/80 text-center',
    };
                ...
                {onSubmit && (
                    <div className={classNames.footer}>
                        <div className={classNames.containerButtons}>
                            <button type="submit" name='submit' className={classNames.submit}>
                                Submit
                            </button>
                            {onDelete && (
                                <button type="button" name='delete' onClick={onDelete} className={classNames.delete}>
                                    Delete
                                </button>
                            )}
                            {onCancel && (
                                <button type="button" name='cancel' onClick={onCancel} className={classNames.cancel}>
                                    Cancel
                                </button>
                            )}
                        </div>
